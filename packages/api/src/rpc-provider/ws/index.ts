...
import { isChildClass, isNull, isUndefined, noop, objectSpread } from '@polkadot/util';
...
export class WsProvider implements ProviderInterface {
  ...
  public async connect(): Promise<void> {
    ...
    try {
      ...
      this.#websocket =
        ...
        isChildClass(xglobal.WebSocket as unknown as Class<WebSocket>, WebSocket)
  ...
  public send<T = any>(
    ...
    let resultPromise: Promise<T> | null = isCacheable ? this.#callCache.get(body) : null;
